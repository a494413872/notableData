---
attachments: [Clipboard_2020-07-08-11-26-08.png, Clipboard_2020-07-08-11-26-57.png, Clipboard_2020-07-08-11-26-58.png, Clipboard_2020-07-08-11-28-16.png, Clipboard_2020-07-08-11-43-10.png, Clipboard_2020-07-08-11-43-44.png, Clipboard_2020-07-08-11-44-12.png, Clipboard_2020-07-08-11-44-57.png, Clipboard_2020-07-08-13-55-33.png, Clipboard_2020-07-08-13-56-40.png, Clipboard_2020-07-08-14-20-23.png, Clipboard_2020-07-08-14-20-42.png]
tags: [java/转载]
title: 2万字长文包教包会 JVM 内存结构
created: '2020-07-08T03:25:08.697Z'
modified: '2020-07-08T06:25:24.298Z'
---

# 2万字长文包教包会 JVM 内存结构

![](@attachment/Clipboard_2020-07-08-11-26-08.png)
...
![](@attachment/Clipboard_2020-07-08-11-26-57.png)
...
![](@attachment/Clipboard_2020-07-08-11-28-16.png)
...
![](@attachment/Clipboard_2020-07-08-11-43-10.png)
2.4 栈帧的内部结构
...
一些附加信息
![](@attachment/Clipboard_2020-07-08-11-43-44.png)
继续深抛栈帧中的五部分~~
2.4.1. 局部变量表
...
![](@attachment/Clipboard_2020-07-08-11-44-12.png)
...
![](@attachment/Clipboard_2020-07-08-11-44-57.png)
...
![](@attachment/Clipboard_2020-07-08-13-55-33.png)
...
![](@attachment/Clipboard_2020-07-08-13-56-40.png)
...
1. 为对象分配内存是一件非常严谨和复杂的任务，JVM 的设计者们不仅需要考虑内存如何分配、在哪里分配等问题，并且由于内存分配算法和内存回收算法密切相关，所以还需要考虑 GC 执行完内存回收后是否会在内存空间中产生内存碎片。
2. new 的对象先放在伊甸园区，此区有大小限制
...
- 方法区（method area）只是JVM规范中定义的一个概念，用于存储类信息、常量池、静态变量、JIT编译后的代码等数据，并没有规定如何去实现它，不同的厂商有不同的实现。而永久代（PermGen）是 Hotspot 虚拟机特有的概念， Java8 的时候又被元空间取代了，永久代和元空间都可以理解为方法区的落地实现。
...
栈、堆、方法区的交互关系
![](@attachment/Clipboard_2020-07-08-14-20-23.png)
5.4 运行时常量池
...
![](@attachment/Clipboard_2020-07-08-14-20-42.png)
